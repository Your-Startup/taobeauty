...
function taobeauty_setup() {
	...
	register_nav_menus(
		array(
			'menu-header' => esc_html__( 'Header', 'taobeauty' ),
			'menu-footer' => esc_html__( 'Footer', 'taobeauty' ),
		)
	);
...
function taobeauty_scripts() {
	...
	// CUSTOM BLOCKS
	wp_enqueue_style( 'taobeauty-style-services', get_template_directory_uri() . '/assets/css/services.css', array(), _S_VERSION );
